...
module Reg
  class XLRegMsg < ::Protobuf::Message
    defined_in __FILE__
    class Tag < ::Protobuf::Enum
      defined_in __FILE__
      RegCredRequest = value(:RegCredRequest, 1)
      RegCredReply = value(:RegCredReply, 2)
      Client = value(:Client, 3)
      ClientOK = value(:ClientOK, 4)
      Create = value(:Create, 5)
      CreateReply = value(:CreateReply, 6)
      Join = value(:Join, 7)
      JoinReply = value(:JoinReply, 8)
      GetCluster = value(:GetCluster, 9)
      ClusterMembers = value(:ClusterMembers, 10)
      Bye = value(:Bye, 11)
      Ack = value(:Ack, 12)
      Error = value(:Error, 13)
    end
    class Token < ::Protobuf::Message
      defined_in __FILE__
      optional :string, :Name, 1
